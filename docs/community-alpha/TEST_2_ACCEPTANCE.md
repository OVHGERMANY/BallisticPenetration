...
2. Confirm the installed `BallisticPenetration.dll` SHA-256 matches `<release DLL SHA-256>` from the selected release's generated checksum metadata.
...
& .\tools\Test-Test2FieldReport.ps1 `
    ...
    -ExpectedDllSha256 '<release DLL SHA-256>' `
